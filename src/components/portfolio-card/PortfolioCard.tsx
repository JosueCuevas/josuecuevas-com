...
const PortfolioCard: React.FC<Props> = ({ project, text_1, text_2 }) => {
  return (
    <section className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 p-4 px-2">
      <div className="block rounded-lg bg-bg-color shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:scale-105 transition-all duration-300 ease-in-out">
        <div
        ...
        <div className="p-6 min-h-[360px] sm:min-h-[520px] md:min-h-[365px] lg:min-h-[460px] flex flex-col justify-between">
          <section>
            <h5 className=" text-xl font-medium leading-tight text-neutral-800 ">
              {project.title}
            </h5>
            <p className="text-extra-gray font-semibold">
              {project.dateProject}
            </p>
          </section>
          <section>

  ...
  return (
    ...
    >
      <article className="bg-bg-opacity pt-12">
        <div className="min-h-screen container mx-auto flex flex-col justify-center text-white md:justify-end md:pb-16 px-3">
          <h1 className="text-4xl font-bold text-center md:text-start ts-1">
            {heroImage.h1_1}
          ...
          <p className="text-center font-semibold mt-12 md:mt-4 md:text-start ts-1">
            {heroImage.p}
          </p>
          <div className="flex justify-between gap-2 w-12/12 mx-auto mt-12 sm:w-2/5 md:justify-start md:gap-4 md:mx-0 md:mt-5">
            <a
